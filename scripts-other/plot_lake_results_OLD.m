...
% % plot(lake.modeled.LH.date(:), lake.modeled.LH.dh(:), 'd--r','LineWidth', 1.5)
% % plot(lake.modeled.LF.date(:), lake.modeled.LF.dh(:), 'o--b','LineWidth', 1.5)
% 
...
% plot(lake_streams.modeled.LB.date(:), lake_streams.modeled.LBhigh.dh(:), '-.', 'Color', [0.5 0.5 0.5], 'LineWidth', 1, 'HandleVisibility','off');
% plot(lake_streams.modeled.LB.date(:), lake_streams.modeled.LBcombo.dh(:), '-.k','LineWidth', 1, 'HandleVisibility','off')
% plot(lake_streams.modeled.LB.date(:), lake_streams.modeled.LBlow.dh(:), '-.', 'Color', [0.5 0.5 0.5], 'LineWidth', 1, 'HandleVisibility','off');
...
% Modeled w/ Stream Inflows
plot(lake_streams.modeled.LH.date(:), lake_streams.modeled.LHhigh.dh(:), '-.', 'Color', [0.5 0.5 0.5], 'LineWidth', 1, 'HandleVisibility','off');
plot(lake_streams.modeled.LH.date(:), lake_streams.modeled.LHcombo.dh(:), '-.k','LineWidth', 1, 'HandleVisibility','off')
plot(lake_streams.modeled.LH.date(:), lake_streams.modeled.LHlow.dh(:), '-.', 'Color', [0.5 0.5 0.5], 'LineWidth', 1, 'HandleVisibility','off');
% Modeled
plot(lake.modeled.LH.date(:), lake.modeled.LH.dh(:), 's--k','LineWidth', 1.5)
% Zero Line
line([datetime(1993,1,1), datetime(2018,1,1)],[0,0], 'Color','k', 'LineWidth', 1)
...
% Modeled w/ Stream Inflows
plot(lake_streams.modeled.LF.date(:), lake_streams.modeled.LFhigh.dh(:), '-.', 'Color', [0.5 0.5 0.5], 'LineWidth', 1, 'HandleVisibility','off');
plot(lake_streams.modeled.LF.date(:), lake_streams.modeled.LFcombo.dh(:), '-.k','LineWidth', 1, 'HandleVisibility','off')
plot(lake_streams.modeled.LF.date(:), lake_streams.modeled.LFlow.dh(:), '-.', 'Color', [0.5 0.5 0.5], 'LineWidth', 1, 'HandleVisibility','off');
% Modeled
