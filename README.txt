...
4. Set options in the `get_melt.m` file.
    - This function reads ICEMELT output and build melt inflow data file for eack lake.
    - The ICEMELT data must be stored in the `/DATA` sub-directory.
5. Set options in the `get_geometry.m` file.
